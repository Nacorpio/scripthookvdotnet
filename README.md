...
All the source code except for the Vector, Matrix and Quaternion classes, which are licensed seperately, is licensed under the conditions of the [zlib license](LICENSE.txt).
